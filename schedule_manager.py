...
def add_schedule(cursor: Cursor):
    ...
    sql = """
            INSERT INTO schedules (title, description, start_datetime, end_datetime) VALUES (%s, %s, %s, %s)
        """
    cursor.execute(sql, args=(title, description, start_datetime, end_datetime))
    print("일정이 추가됨.")
